...
<div style={css("min-height:100vh; display:flex; align-items:center; justify-content:center; padding:40px; font-family:Pretendard,-apple-system,sans-serif; color:#1A1A1D;")}>
  <div style={css("width:390px; height:844px; background:#F4F5F7; border-radius:40px; box-shadow:0 24px 64px rgba(20,20,29,.22); overflow:hidden; position:relative; border:1px solid #ECEEF1; display:flex; flex-direction:column;")}>
    ...
    <div className="scr" style={css("flex:1; overflow-y:auto; position:relative;")}>
      ...
      {v.isPlanner ? (<>
        {v.isPlannerPrompt ? (<>
          <div data-screen-label="AI 프롬프트 입력" style={css("position:absolute; inset:0; z-index:15; background:#F4F5F7; display:flex; flex-direction:column;")}>
            <div style={css("padding:4px 22px 8px; flex:none; display:flex; align-items:center; gap:12px;")}><span className="msr" style={css("font-size:24px; color:#C7CAD0;")}>arrow_back_ios_new</span><span style={css("font:800 18px Pretendard;")}>AI 동선 플래너</span></div>
            <div style={css("flex:1; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:0 30px; text-align:center;")}>
              ...
              <div style={css("font:500 15px Pretendard; color:#8A8F98; margin-top:12px; line-height:1.55;")}>가고 싶은 지역·분위기를 한 줄로 적어주세요.<br />AI가 펫 동반 코스를 그려드려요.</div>
              <div style={css("width:100%; margin-top:28px; display:flex; flex-direction:column; gap:11px;")}>
                <div onClick={v.submitPrompt} style={css("background:#fff; border-radius:16px; padding:15px 18px; box-shadow:0 4px 16px rgba(20,20,29,.05); display:flex; align-items:center; gap:11px; cursor:pointer;")}><span className="msf" style={css("font-size:18px; color:#3B5BFE;")}>bolt</span><span style={css("font:600 14px Pretendard;")}>전주 한옥마을 반나절 코스</span></div>
                <div onClick={v.submitPrompt} style={css("background:#fff; border-radius:16px; padding:15px 18px; box-shadow:0 4px 16px rgba(20,20,29,.05); display:flex; align-items:center; gap:11px; cursor:pointer;")}><span className="msf" style={css("font-size:18px; color:#3B5BFE;")}>bolt</span><span style={css("font:600 14px Pretendard;")}>대형견 OK 카페 위주로</span></div>
                <div onClick={v.submitPrompt} style={css("background:#fff; border-radius:16px; padding:15px 18px; box-shadow:0 4px 16px rgba(20,20,29,.05); display:flex; align-items:center; gap:11px; cursor:pointer;")}><span className="msf" style={css("font-size:18px; color:#3B5BFE;")}>bolt</span><span style={css("font:600 14px Pretendard;")}>그늘 많은 산책 코스</span></div>
              </div>
            </div>
            <div style={css("padding:0 22px 16px; flex:none;")}>
              <div onClick={v.submitPrompt} style={css("background:#fff; border-radius:18px; padding:8px 8px 8px 18px; box-shadow:0 6px 20px rgba(20,20,29,.08); display:flex; align-items:center; gap:10px; cursor:pointer;")}><span style={css("flex:1; font:500 15px Pretendard; color:#1A1A1D;")}>체리랑 전주 한옥마을 반나절<span style={css("color:#3B5BFE;")}>|</span></span><div style={css("width:48px; height:48px; border-radius:14px; background:#3B5BFE; color:#fff; display:flex; align-items:center; justify-content:center; flex:none;")}><span className="msf" style={css("font-size:24px;")}>arrow_upward</span></div></div>
              <div style={css("text-align:center; font:400 11px Pretendard; color:#A9A8A2; margin-top:12px;")}>데이터: 한국관광공사 반려동물 동반여행</div>
            </div>
          </div>
        </>) : null}
        {v.isPlannerResults ? (<>
      ...
      {v.isDog ? (<>
        <div data-screen-label="내 강아지" style={css("padding:0 0 96px;")}>
          ...
          <div style={css("background:linear-gradient(180deg,#EEF1FF,#F4F5F7); padding:8px 22px 22px; text-align:center;")}>
            <div style={css("position:relative; width:104px; height:104px; margin:0 auto;")}>
              <div style={css("position:absolute; inset:0; border-radius:50%; background:linear-gradient(135deg,#F8D9A8,#EBB06A); box-shadow:0 12px 30px rgba(59,91,254,.16); display:flex; align-items:flex-end; justify-content:center; overflow:hidden;")}>
                <div style={css("position:relative; width:74px; height:68px; margin-bottom:6px;")}><div style={css("position:absolute; left:6px; top:2px; width:20px; height:30px; border-radius:60% 40% 50% 50%; background:radial-gradient(circle at 40% 28%, #E8B06A, #D99A4E 58%, #BE8038); transform:rotate(-16deg);")}></div><div style={css("position:absolute; right:6px; top:2px; width:20px; height:30px; border-radius:40% 60% 50% 50%; background:radial-gradient(circle at 40% 28%, #E8B06A, #D99A4E 58%, #BE8038); transform:rotate(16deg);")}></div><div style={css("position:absolute; left:11px; top:12px; width:52px; height:52px; border-radius:50%; background:radial-gradient(circle at 38% 28%, #FCE6BC, #F4C98A 52%, #DFA45E);")}></div><div style={css("position:absolute; left:22px; top:30px; width:8px; height:8px; border-radius:50%; background:#2A2A2A;")}></div><div style={css("position:absolute; right:22px; top:30px; width:8px; height:8px; border-radius:50%; background:#2A2A2A;")}></div><div style={css("position:absolute; left:31px; top:42px; width:12px; height:9px; border-radius:50%; background:#2A2A2A;")}></div></div>
              </div>
            </div>
            ...
            <div style={css("display:flex; gap:6px; justify-content:center; flex-wrap:wrap; margin-top:12px;")}>
              ...
              <span style={css("font:600 12px Pretendard; background:#fff; border:1px solid #ECEEF1; padding:7px 12px; border-radius:999px;")}>사교형</span>
              <span style={css("display:inline-flex; align-items:center; gap:4px; font:600 12px Pretendard; background:#FFF1EF; color:#FF6B5C; padding:7px 12px; border-radius:999px;")}><span className="msf" style={css("font-size:13px;")}>sunny</span>더위 취약</span>
          ...
          {v.dogIsDress ? (<>
            ...
            <div style={css("padding:16px 22px 0;")}>
              <div style={css("background:linear-gradient(135deg,#EEF1FF,#F4F5F7); border-radius:20px; padding:24px; text-align:center;")}>
                <div style={css("position:relative; width:120px; height:120px; margin:0 auto; filter:drop-shadow(0 12px 24px rgba(59,91,254,.16));")}>
                  <div style={css("position:absolute; inset:0; border-radius:50%; background:#fff;")}></div>
                  <div style={css("position:absolute; left:18px; top:14px; width:28px; height:40px; border-radius:60% 40% 50% 50%; background:radial-gradient(circle at 40% 28%, #EEBE82, #E0A867 58%, #C68A45); transform:rotate(-20deg);")}></div>
                  <div style={css("position:absolute; right:18px; top:14px; width:28px; height:40px; border-radius:40% 60% 50% 50%; background:radial-gradient(circle at 40% 28%, #EEBE82, #E0A867 58%, #C68A45); transform:rotate(20deg);")}></div>
                  <div style={css("position:absolute; left:24px; top:22px; width:72px; height:72px; border-radius:50%; background:radial-gradient(circle at 38% 28%, #FCE6BC, #F4C98A 52%, #DFA45E);")}></div>
                  <div style={css("position:absolute; left:40px; top:48px; width:11px; height:11px; border-radius:50%; background:#2A2A2A;")}></div>
                  <div style={css("position:absolute; right:40px; top:48px; width:11px; height:11px; border-radius:50%; background:#2A2A2A;")}></div>
                  <div style={css("position:absolute; left:50%; top:64px; transform:translateX(-50%); width:16px; height:11px; border-radius:50%; background:#2A2A2A;")}></div>
                  <div style={css("position:absolute; left:50%; bottom:-2px; transform:translateX(-50%); width:90px; height:36px; border-radius:18px 18px 8px 8px; background:linear-gradient(135deg,#C8527A,#A23B62);")}></div>
                </div>
                <div style={css("font:700 14px Pretendard; margin-top:14px;")}>체리, 전주 한옥마을에서 한복</div>
              </div>
              ...
              <div style={css("display:grid; grid-template-columns:1fr 1fr; gap:12px; margin-top:16px;")}>
                <div style={css("background:#fff; border:2px solid #3B5BFE; border-radius:16px; padding:8px; box-shadow:0 6px 20px rgba(59,91,254,.12);")}><div style={css("aspect-ratio:1; border-radius:11px; background:linear-gradient(135deg,#F4C6BE,#E0809A); position:relative;")}><span className="msf" style={css("position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); font-size:30px; color:rgba(255,255,255,.7);")}>checkroom</span></div><div style={css("font:600 12px Pretendard; text-align:center; margin-top:8px;")}>분홍 저고리</div></div>
                <div style={css("background:#fff; border:1px solid #ECEEF1; border-radius:16px; padding:8px;")}><div style={css("aspect-ratio:1; border-radius:11px; background:linear-gradient(135deg,#BFD3F0,#8FAEE0); position:relative;")}><span className="msf" style={css("position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); font-size:30px; color:rgba(255,255,255,.7);")}>checkroom</span></div><div style={css("font:600 12px Pretendard; text-align:center; margin-top:8px;")}>남색 도포</div></div>
                <div style={css("background:#fff; border:1px solid #ECEEF1; border-radius:16px; padding:8px; position:relative;")}><div style={css("aspect-ratio:1; border-radius:11px; background:linear-gradient(135deg,#E9D7B8,#CBB182); position:relative;")}><span className="msf" style={css("position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); font-size:30px; color:rgba(255,255,255,.7);")}>photo_album</span><div style={css("position:absolute; top:7px; right:7px; width:24px; height:24px; border-radius:50%; background:rgba(0,0,0,.4); display:flex; align-items:center; justify-content:center; color:#fff;")}><span className="msf" style={css("font-size:14px;")}>lock</span></div></div><div style={css("display:flex; align-items:center; justify-content:center; gap:5px; margin-top:8px;")}><span style={css("font:600 12px Pretendard;")}>포토북</span><span style={css("font:600 10px Pretendard; color:#3B5BFE; background:#EEF1FF; padding:2px 7px; border-radius:999px;")}>구매</span></div></div>
                <div style={css("background:#fff; border:1px solid #ECEEF1; border-radius:16px; padding:8px; position:relative;")}><div style={css("aspect-ratio:1; border-radius:11px; background:linear-gradient(135deg,#D7C0E9,#B088D0); position:relative;")}><span className="msf" style={css("position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); font-size:30px; color:rgba(255,255,255,.7);")}>deployed_code</span><div style={css("position:absolute; top:7px; right:7px; width:24px; height:24px; border-radius:50%; background:rgba(0,0,0,.4); display:flex; align-items:center; justify-content:center; color:#fff;")}><span className="msf" style={css("font-size:14px;")}>lock</span></div></div><div style={css("display:flex; align-items:center; justify-content:center; gap:5px; margin-top:8px;")}><span style={css("font:600 12px Pretendard;")}>3D 피규어</span><span style={css("font:600 10px Pretendard; color:#3B5BFE; background:#EEF1FF; padding:2px 7px; border-radius:999px;")}>구매</span></div></div>
              </div>
            ...
            {v.dressIsApplying ? (<>
              <div style={css("padding:0 22px; flex:1; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; min-height:420px;")}>
                ...
                <div style={css("font:800 21px Pretendard; letter-spacing:-0.02em; margin-top:24px;")}>분홍 저고리 입히는 중...</div>
            ...
            {v.dressIsResult ? (<>
              <div style={css("padding:16px 22px 0;")}>
                <div style={css("height:300px; border-radius:24px; background:linear-gradient(160deg,#F4C6BE,#E0809A); position:relative; display:flex; align-items:center; justify-content:center; box-shadow:0 12px 30px rgba(20,20,29,.12);")}>
                  <div style={css("position:relative; width:150px; height:150px; filter:drop-shadow(0 12px 22px rgba(0,0,0,.18));")}><div style={css("position:absolute; inset:0; border-radius:50%; background:#fff;")}></div><div style={css("position:absolute; left:24px; top:18px; width:34px; height:48px; border-radius:60% 40% 50% 50%; background:radial-gradient(circle at 40% 28%, #EEBE82, #E0A867 58%, #C68A45); transform:rotate(-20deg);")}></div><div style={css("position:absolute; right:24px; top:18px; width:34px; height:48px; border-radius:40% 60% 50% 50%; background:radial-gradient(circle at 40% 28%, #EEBE82, #E0A867 58%, #C68A45); transform:rotate(20deg);")}></div><div style={css("position:absolute; left:31px; top:26px; width:88px; height:88px; border-radius:50%; background:radial-gradient(circle at 38% 28%, #FCE6BC, #F4C98A 52%, #DFA45E);")}></div><div style={css("position:absolute; left:50px; top:56px; width:12px; height:12px; border-radius:50%; background:#2A2A2A;")}></div><div style={css("position:absolute; right:50px; top:56px; width:12px; height:12px; border-radius:50%; background:#2A2A2A;")}></div><div style={css("position:absolute; left:50%; top:76px; transform:translateX(-50%); width:17px; height:12px; border-radius:50%; background:#2A2A2A;")}></div><div style={css("position:absolute; left:50%; bottom:-4px; transform:translateX(-50%); width:120px; height:48px; border-radius:22px 22px 10px 10px; background:linear-gradient(135deg,#C8527A,#A23B62);")}></div></div>
                  <span style={css("position:absolute; bottom:14px; left:50%; transform:translateX(-50%); font:700 12px Pretendard; color:#fff; text-shadow:0 1px 6px rgba(0,0,0,.3);")}>체리, 전주 한옥마을에서 한복</span>
                </div>
      ...
      <div data-screen-label="이름 입력" style={css("position:absolute; inset:0; z-index:40; background:#F4F5F7; display:flex; flex-direction:column;")}>
        ...
        <div style={css("flex:1; padding:24px 28px 0;")}>
          ...
          <div style={css("margin-top:32px; display:flex; flex-direction:column; align-items:center;")}>
            <div style={css("width:96px; height:96px; border-radius:50%; background:linear-gradient(135deg,#F8D9A8,#EBB06A); display:flex; align-items:flex-end; justify-content:center; overflow:hidden;")}><div style={css("position:relative; width:70px; height:64px; margin-bottom:5px;")}><div style={css("position:absolute; left:6px; top:2px; width:18px; height:27px; border-radius:60% 40% 50% 50%; background:radial-gradient(circle at 40% 28%, #E8B06A, #D99A4E 58%, #BE8038); transform:rotate(-16deg);")}></div><div style={css("position:absolute; right:6px; top:2px; width:18px; height:27px; border-radius:40% 60% 50% 50%; background:radial-gradient(circle at 40% 28%, #E8B06A, #D99A4E 58%, #BE8038); transform:rotate(16deg);")}></div><div style={css("position:absolute; left:10px; top:11px; width:50px; height:50px; border-radius:50%; background:radial-gradient(circle at 38% 28%, #FCE6BC, #F4C98A 52%, #DFA45E);")}></div><div style={css("position:absolute; left:21px; top:29px; width:7px; height:7px; border-radius:50%; background:#2A2A2A;")}></div><div style={css("position:absolute; right:21px; top:29px; width:7px; height:7px; border-radius:50%; background:#2A2A2A;")}></div><div style={css("position:absolute; left:30px; top:41px; width:11px; height:8px; border-radius:50%; background:#2A2A2A;")}></div></div></div>
          </div>
    ...
    {v.isBreed ? (<>
      <div data-screen-label="견종 인식" style={css("position:absolute; inset:0; z-index:40; background:#F4F5F7; display:flex; flex-direction:column;")}>
        ...
        <div style={css("flex:1; padding:18px 28px 0; overflow-y:auto;")} className="scr">
          <div style={css(`height:170px; border-radius:20px; background:linear-gradient(135deg,#F6D49B,#E7AE66); display:flex; align-items:center; justify-content:center; overflow:hidden; ${v.photoStyle}`)}>{v.noPhoto ? (<span className="msr" style={css("font-size:64px; color:rgba(255,255,255,.55);")}>pets</span>) : null}</div>
    ...
    {v.isComplete ? (<>
      <div data-screen-label="프로필 완성" style={css("position:absolute; inset:0; z-index:40; background:linear-gradient(180deg,#EEF1FF 0%,#F4F5F7 38%); display:flex; flex-direction:column;")}>
        ...
        <div style={css("flex:1; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:0 32px; text-align:center;")}>
          <div style={css("position:relative; width:120px; height:120px;")}>{v.hasPhoto ? (<div onMouseDown={v.onDragStart} onTouchStart={v.onDragStart} style={css(`position:absolute; inset:0; border-radius:50%; overflow:hidden; cursor:grab; touch-action:none; box-shadow:0 16px 40px rgba(59,91,254,.18); ${v.fig3dStyle}`)}></div>) : (<div style={css("position:absolute; inset:0; border-radius:50%; background:#fff; box-shadow:0 16px 40px rgba(59,91,254,.18); display:flex; align-items:center; justify-content:center;")}><div style={css("position:relative; width:90px; height:82px;")}><div style={css("position:absolute; left:7px; top:4px; width:24px; height:35px; border-radius:60% 40% 50% 50%; background:radial-gradient(circle at 40% 28%, #EEBE82, #E0A867 58%, #C68A45); transform:rotate(-18deg);")}></div><div style={css("position:absolute; right:7px; top:4px; width:24px; height:35px; border-radius:40% 60% 50% 50%; background:radial-gradient(circle at 40% 28%, #EEBE82, #E0A867 58%, #C68A45); transform:rotate(18deg);")}></div><div style={css("position:absolute; left:13px; top:13px; width:64px; height:64px; border-radius:50%; background:radial-gradient(circle at 38% 28%, #FCE6BC, #F4C98A 52%, #DFA45E);")}></div><div style={css("position:absolute; left:29px; top:34px; width:9px; height:9px; border-radius:50%; background:#2A2A2A;")}></div><div style={css("position:absolute; right:29px; top:34px; width:9px; height:9px; border-radius:50%; background:#2A2A2A;")}></div><div style={css("position:absolute; left:39px; top:49px; width:13px; height:9px; border-radius:50%; background:#2A2A2A;")}></div></div></div>)}<div style={css("position:absolute; right:0; bottom:0; width:38px; height:38px; border-radius:50%; background:#3B5BFE; color:#fff; display:flex; align-items:center; justify-content:center; border:4px solid #EEF1FF;")}><span className="msf" style={css("font-size:20px;")}>check</span></div></div>{v.hasPhoto ? (<div style={css("margin-top:12px; display:inline-flex; align-items:center; gap:5px; font:700 11px Pretendard; color:#3B5BFE; background:#EEF1FF; padding:6px 12px; border-radius:999px;")}><span className="msf" style={css("font-size:13px;")}>view_in_ar</span>AI 3D 모델 미리보기 · 드래그로 회전 (MVP)</div>) : null}
    ...
    {v.isPersona ? (<>
      <div data-screen-label="페르소나" style={css("position:absolute; inset:0; z-index:40; background:#F4F5F7; display:flex; flex-direction:column;")}>
        ...
        <div className="scr" style={css("flex:1; overflow-y:auto; padding:16px 28px 0; display:flex; flex-direction:column; align-items:center;")}>
          {v.personaIsMascot ? (<>
            <div onMouseDown={v.onDragStart} onTouchStart={v.onDragStart} style={css(`position:relative; width:170px; height:170px; filter:drop-shadow(0 18px 30px rgba(59,91,254,.22)); cursor:grab; touch-action:none; ${v.fig3dStyle}`)}><div style={css("position:absolute; inset:0; border-radius:50%; background:radial-gradient(circle at 38% 32%, #fff, #E9ECF5);")}></div><div style={css("position:absolute; left:22px; top:16px; width:40px; height:56px; border-radius:60% 40% 50% 50%; background:linear-gradient(135deg,#E8B575,#CE8E45);")}></div><div style={css("position:absolute; right:22px; top:16px; width:40px; height:56px; border-radius:40% 60% 50% 50%; background:linear-gradient(135deg,#E8B575,#CE8E45);")}></div><div style={css("position:absolute; left:30px; top:28px; width:110px; height:110px; border-radius:50%; background:radial-gradient(circle at 40% 34%, #FAD49A, #E8B36F);")}></div><div style={css("position:absolute; left:54px; top:62px; width:15px; height:15px; border-radius:50%; background:#2A2A2A; box-shadow:inset 2px -2px 2px rgba(255,255,255,.4);")}></div><div style={css("position:absolute; right:54px; top:62px; width:15px; height:15px; border-radius:50%; background:#2A2A2A; box-shadow:inset 2px -2px 2px rgba(255,255,255,.4);")}></div><div style={css("position:absolute; left:50%; top:86px; transform:translateX(-50%); width:22px; height:16px; border-radius:50%; background:#2A2A2A;")}></div></div>
          </>) : null}
          {v.personaIsReal ? (<>
            {v.hasPhoto ? (<>
              <div onMouseDown={v.onDragStart} onTouchStart={v.onDragStart} style={css(`width:200px; height:230px; border-radius:24px; ${v.fig3dStyle} box-shadow:0 24px 48px rgba(59,91,254,.28), inset 0 0 0 4px rgba(255,255,255,.7); cursor:grab; touch-action:none;`)}></div>
            </>) : null}
            {v.noPhoto ? (<>
              <div onMouseDown={v.onDragStart} onTouchStart={v.onDragStart} style={css(`width:200px; height:230px; border-radius:24px; background:linear-gradient(160deg,#F0BE7C,#E09A52); position:relative; overflow:hidden; box-shadow:0 24px 48px rgba(20,20,29,.22), inset 0 0 0 4px rgba(255,255,255,.6); cursor:grab; touch-action:none; ${v.fig3dStyle}`)}>
                <span className="msr" style={css("position:absolute; top:40%; left:50%; transform:translate(-50%,-50%); font-size:74px; color:rgba(255,255,255,.5);")}>pets</span>
                <span style={css("position:absolute; bottom:14px; left:50%; transform:translateX(-50%); font:600 10px ui-monospace,monospace; color:rgba(255,255,255,.85);")}>사진을 올리면 3D 실사로</span>
              </div>
            </>) : null}
          </>) : null}
          ...
          <div style={css("width:100%; background:#fff; border-radius:22px; padding:22px; margin-top:22px; box-shadow:0 10px 30px rgba(20,20,29,.07);")}>
            ...
            <div style={css("display:flex; gap:7px; flex-wrap:wrap; margin-top:16px;")}><span style={css("font:600 12px Pretendard; background:#F4F5F7; border:1px solid #ECEEF1; padding:7px 12px; border-radius:999px;")}>활발함</span><span style={css("font:600 12px Pretendard; background:#F4F5F7; border:1px solid #ECEEF1; padding:7px 12px; border-radius:999px;")}>호기심 많음</span><span style={css("font:600 12px Pretendard; background:#F4F5F7; border:1px solid #ECEEF1; padding:7px 12px; border-radius:999px;")}>다정함</span></div>
    ...
    {v.isTraits ? (<>
      <div data-screen-label="특징 편집" style={css("position:absolute; inset:0; z-index:50; background:#F4F5F7; display:flex; flex-direction:column;")}>
        ...
        <div className="scr" style={css("flex:1; overflow-y:auto; padding:6px 22px 28px;")}>
          ...
          <div style={css("display:flex; gap:8px; flex-wrap:wrap;")}><span style={css("font:600 13px Pretendard; background:#1A1A1D; color:#fff; padding:9px 15px; border-radius:999px;")}>활동량 많음</span><span style={css("font:600 13px Pretendard; background:#fff; border:1px solid #DfE2E6; padding:9px 15px; border-radius:999px;")}>보통</span><span style={css("font:600 13px Pretendard; background:#fff; border:1px solid #DfE2E6; padding:9px 15px; border-radius:999px;")}>차분함</span></div>
          <div style={css("font:600 13px Pretendard; color:#8A8F98; margin:20px 0 10px;")}>사회성</div>
          <div style={css("display:flex; gap:8px; flex-wrap:wrap;")}><span style={css("font:600 13px Pretendard; background:#1A1A1D; color:#fff; padding:9px 15px; border-radius:999px;")}>사람 좋아함</span><span style={css("font:600 13px Pretendard; background:#fff; border:1px solid #DfE2E6; padding:9px 15px; border-radius:999px;")}>낯가림</span><span style={css("font:600 13px Pretendard; background:#fff; border:1px solid #DfE2E6; padding:9px 15px; border-radius:999px;")}>겁 많음</span></div>
          <div style={css("font:600 13px Pretendard; color:#8A8F98; margin:20px 0 10px;")}>체질 주의</div>
          <div style={css("display:flex; gap:8px; flex-wrap:wrap;")}><span style={css("display:inline-flex; align-items:center; gap:5px; font:600 13px Pretendard; background:#FF6B5C; color:#fff; padding:9px 15px; border-radius:999px;")}><span className="msf" style={css("font-size:15px;")}>sunny</span>더위 취약</span><span style={css("font:600 13px Pretendard; background:#fff; border:1px solid #DfE2E6; padding:9px 15px; border-radius:999px;")}>추위 취약</span><span style={css("font:600 13px Pretendard; background:#fff; border:1px solid #DfE2E6; padding:9px 15px; border-radius:999px;")}>관절 주의</span></div>
        </div>
