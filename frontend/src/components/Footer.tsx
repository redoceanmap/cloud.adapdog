      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-6 text-sm text-brown-light">
            ...
            <a href="#sensory-map" className="hover:text-coral transition-colors">
              감각 지도
            </a>
            <a href="#flow" className="hover:text-coral transition-colors">
              이용 방법
            </a>
            <Link href="/login" className="hover:text-coral transition-colors">
              로그인
            </Link>
            <Link href="/register" className="hover:text-coral transition-colors">
              회원가입
            </Link>
          </div>
